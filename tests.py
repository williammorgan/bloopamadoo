...
class BloopamadooTests(unittest.TestCase):
    ...
    def test_adsr(self):
        ...
        self.assertAlmostEqual(next(adsr), 0.2,  places = 2)
        self.assertAlmostEqual(next(adsr), 0.4,  places = 2)
        self.assertAlmostEqual(next(adsr), 0.6,  places = 2)
        self.assertAlmostEqual(next(adsr), 0.8,  places = 2)
        self.assertAlmostEqual(next(adsr), 1.0,  places = 2)
        self.assertAlmostEqual(next(adsr), 0.95, places = 2)
        self.assertAlmostEqual(next(adsr), 0.90, places = 2)
        self.assertAlmostEqual(next(adsr), 0.85, places = 2)
        self.assertAlmostEqual(next(adsr), 0.80, places = 2)
        self.assertAlmostEqual(next(adsr), 0.75, places = 2)
        self.assertAlmostEqual(next(adsr), 0.75, places = 2)
        self.assertAlmostEqual(next(adsr), 0.75, places = 2)
        self.assertAlmostEqual(adsr.send(True), 0.60, places = 2)
        self.assertAlmostEqual(next(adsr), 0.45, places = 2)
        self.assertAlmostEqual(next(adsr), 0.30, places = 2)
        self.assertAlmostEqual(next(adsr), 0.15, places = 2)
        self.assertAlmostEqual(next(adsr), 0.0, places = 2)
